...
const fullWordCategories = require("categorized-words");
...
const extendWordCategories = (exceptions = {}) => {
  ...
  for (const verb of fullWordCategories.V) {
    extractedCategories[verb] || (extractedCategories[verb] = ["VB"]);
  }
